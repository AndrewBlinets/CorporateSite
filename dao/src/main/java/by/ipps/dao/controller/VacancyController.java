...
public class VacancyController extends BaseEntityAbstractController<Vacancy, VacancyService>
  ...
  protected VacancyController(
      VacancyService vacancyService, ModelMapper modelMapper, LoggerService loggerService) {
    super(vacancyService, modelMapper, loggerService);
  }
  ...
  @Override
  @JsonView(ViewVacancy.BaseClass.class)
  public ResponseEntity<Page<Vacancy>> getAll(
  ...
  @Override
  @JsonView(ViewVacancy.BaseClass.class)
  public ResponseEntity<List<Vacancy>> getAll(Sort sort) {
