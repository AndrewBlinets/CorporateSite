...
public class DepartmentController
  ...
  protected DepartmentController(
      DepartmentService departmentService, ModelMapper modelMapper, LoggerService loggerService) {
    super(departmentService, modelMapper, loggerService);
  }
  ...
  @Override
  @JsonView(ViewDepartment.BaseClassDepartment.class)
  public ResponseEntity<List<Department>> getAll(Sort sort) {
