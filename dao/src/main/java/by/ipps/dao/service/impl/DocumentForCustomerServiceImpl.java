...
public class DocumentForCustomerServiceImpl
  ...
  @Override
  public Page<DocumentForCustomer> getDocumentForCustomerByIdProject(
  ...
  @Override
  public List<DocumentForCustomer> getDocumentForCustomerByIdProject(
      Customer customer, Project project) {
    return this.repository.findDocumentByProject(customer, project);
  }

  @Override
  public Page<DocumentForCustomer> getDocumentForCustomerByIdSheet(
  ...
  @Override
  public Page<DocumentForCustomer> getDocumentForCustomerByProject(Pageable pageable, Project project) {
    return this.repository.findDocumentByProject(pageable, project);
  }
}
