...
public class BaseEntity implements Serializable {
  ...
  @JsonView({
    ViewNewsForCustomer.BaseForAdmin.class,
    ViewUserPortal.BaseClass.class,
    ViewPosition.BaseClass.class,
    ViewRole.BaseClass.class,
    ...
    ViewVacancy.BaseClass.class,
    ViewProject.BaseForAdminClass.class
  })
  @Id
  @Column
  ...
  @JsonView({ViewNews.AdminNewsClass.class, ViewDocumentForCustomer.FileClass.class, ViewNewsForCustomer.BaseForAdmin.class})
  private Date dti;
