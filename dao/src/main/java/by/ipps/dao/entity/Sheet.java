...
public class Sheet extends BaseEntity implements Serializable {
  ...
  @JsonView({ViewPage.AdminClass.class, ViewDocumentForCustomer.FileClass.class, ViewProject.BaseForAdminClass.class})
  @OneToMany(fetch = FetchType.LAZY, cascade = CascadeType.ALL)
  @Filter(name = FilterName.LANGUAGE)
  private List<PageLanguageVersion> languageVersions;

  @Column
  @JsonView({ViewPage.AdminClass.class, ViewProject.BaseForAdminClass.class})
  private int code;
