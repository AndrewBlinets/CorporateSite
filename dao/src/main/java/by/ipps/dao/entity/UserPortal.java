...
public class UserPortal extends BaseEntity implements Serializable {
  ...
  @JsonView({ViewCustomer.BaseClass.class, ViewUserPortal.BaseClass.class})
  @Column(length = 100)
  protected String email;

  @JsonView({ViewContact.BaseClass.class, ViewUserPortal.ById.class})
  @Column
  ...
  @JoinTable(
      ...
      joinColumns = @JoinColumn(name = "id_user", updatable = true, insertable = true),
      inverseJoinColumns = {
